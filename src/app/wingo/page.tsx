  ...
  return (
    <>
      ...
      <PageHero
        ...
        intro="Not just 'pick a number and hope' — Wingo runs on a specific colour mapping and payout structure. Here's the actual mechanic, with real figures, before you place anything."
      />

      <Section>
        <div className="grid gap-10 lg:grid-cols-[1fr_280px] lg:items-start">
          <div>
            <SectionHeading eyebrow="Format" title="The number-colour mapping behind every round" />
            <div className="space-y-4 text-sm leading-relaxed text-slate-300">
              <p>
                Every Wingo round draws one number from 0 to 9, and that number carries a colour
                and a size along with it. In the standard mapping used across this game category,
                1, 3, 7 and 9 come up Green; 2, 4, 6 and 8 come up Red; and 0 and 5 are the two
                Violet numbers layered on top of Red and Green respectively. Size works on a
                separate split: 0 through 4 counts as Small, 5 through 9 counts as Big. A result
                of 7, for example, is simultaneously Green, Big, and just &quot;7&quot; for number-bet
                purposes — three ways the same draw can pay out at once.
              </p>
              <p>
                Rounds queue back-to-back on a fixed timer with a visible period number, which is
                why Wingo feels faster and more continuous than a traditional lottery draw. That
                same speed is exactly why a personal budget set before you start matters more here
                than in slower formats — see our full breakdown below before you set one.
              </p>
            </div>
          </div>
